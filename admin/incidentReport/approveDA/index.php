                        ...
                        <tbody>
                            ...
                            if ($is_operator > 0) {
                                ...
                                if ($_settings->userdata('EMPPOSITION') == 5) {
                                    ...
                                    (`ir_status` = 2 and appeal_status = 2)
                                    ORDER BY `date_created` asc");
                                } elseif ($is_quality > 0) {
                                    $ir_da_qry = $conn->query("SELECT * FROM ir_requests where 
                                    ...
                                    // $ir_da_qry = $conn->query("SELECT * FROM ir_requests WHERE 
                                    // (`ir_status` = 2 and da_status = 2 and dm_name ='{$_settings->userdata('EMPLOYID')}'  and dh_name = '{$_settings->userdata('EMPLOYID')}') or
                                    // (`ir_status` = 2 and da_status = 3 and dm_name ='{$_settings->userdata('EMPLOYID')}' and dh_name != '{$_settings->userdata('EMPLOYID')}') or
                                    // ( ir_status = 2 and  da_status = 3 and dh_name = '{$_settings->userdata('EMPLOYID')}' and dm_name = '{$_settings->userdata('EMPLOYID')}') or
                                        ...
                                        <td align="center">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <?php if ($row['ir_status'] == 2 && $row['has_da'] == 1) { ?>
                                                    ...
                                                    <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/viewDA&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Sign DA</a>
                                                <?php } elseif ($row['ir_status'] == 3 && $row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 2) { ?>
                                                    <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/view_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Edit</a>
                                                <?php } elseif ($row['ir_status'] == 1 && $row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 0) { ?>
                                                    <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/validate_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> validate</a>
                                                <?php } else { ?>
                                                    <?php if ($row['hr_status'] == 1 && $row['sv_status'] == 0 && $row['sv_name'] == $_settings->userdata('EMPLOYID')) { ?>
                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/view_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Assess</a>
                                                    <?php } elseif ($row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 0 && ($is_operator > 0)) { ?>

                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/validate_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Sign</a>
                                                    <?php } elseif ($row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 1 && $_settings->userdata('EMPPOSITION') >= 3 && $_settings->userdata('DEPARTMENT') == 'Human Resource') { ?>
                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/appeal_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Sign</a>
                                                    <?php } elseif ($row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 1 && $_settings->userdata('EMPPOSITION') >= 3 && $_settings->userdata('DEPARTMENT') != 'Human Resource') { ?>
                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/appeal_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Sign</a>
                                                    <?php } else { ?>
                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/sign_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Sign</a>
                                                    <?php } ?>
                                                <?php } ?>
                                ...
                                <?php } elseif ($row['has_da'] == 1 && $c > 0) { ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <?php if ($row['ir_status'] == 2 && $row['has_da'] == 1) { ?>
                                                    <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/view_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View IR</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/viewDA&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> Sign DA</a>
                                                <?php } elseif ($row['ir_status'] == 3 && $row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 2) { ?>
                                                    <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/view_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Edit</a>
                                                <?php } elseif ($row['ir_status'] == 1 && $row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 0) { ?>
                                                    <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/validate_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Edit</a>
                                                <?php } else { ?>
                                                    <?php if ($row['hr_status'] == 1 && $row['sv_status'] == 0 && $row['sv_name'] == $_settings->userdata('EMPLOYID')) { ?>
                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/view_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Assess</a>
                                                    <?php } elseif ($row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 0 && ($is_operator > 0)) { ?>
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/validate_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Sign</a>
                                                    <?php } elseif ($row['hr_status'] == 1 && $row['sv_status'] == 1 && $row['da_status'] == 1 && $_settings->userdata('EMPPOSITION') >= 3) { ?>

                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/view_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Sign</a>
                                                    <?php } else { ?>
                                                        <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/sign_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Sign</a>
                                                    <?php } ?>
                                                <?php } ?>
                                ...
                                <?php } elseif ($row['has_da'] == 0 && $row['ir_status'] == 2 && $c > 0) { ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/validate_ir&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View IR</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="<?php echo base_url . 'admin?page=incidentreport/approveDA/new_da&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-pen text-dark"></span> Issue D.A</a>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: _base_url_ + "admin/incidentReport/approveDA/history_index_da.php",
            method: "POST",
