        ...
        <form action="" id="ir-form">
            ...
            <div class="container-fluid">
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <!-- <?php if ($why1 != '') { ?>
                                    <th class="text-center py-1 px-2 dont_">Explanation</th>
                                <?php } ?> -->
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="text-center">
                                    ...
                                    <!-- <?php if ($row['why1'] != '') { ?>
                                        <td class="dont_">
                                            <a class="btn btn-sm btn-block edt" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fas fa-eye"></span></a>
                                        </td>
                                    <?php } ?> -->
                ...
                <div class="row justify-content-between">
                    ...
                    <?php } else if (($hr_status == 0 && $_settings->userdata('DEPARTMENT') == 'Human Resource' && $quality_violation == 1) || ($hr_status == 0 && $_settings->userdata('EMPLOYID') == 1191 && $quality_violation == 1)) { ?>
                        ...
                        <div class="col-5">
                            ...
                            <div class="button-wrapp text-center">
                                ...
                                <button class="btn btn-flat btn-lg btn-outline-danger disapprove_data" type="button" data-id="<?php echo $id ?>" data-val="2" data-sign="3" data-name="<?php echo $_settings->userdata('EMPLOYID') ?>"> <i class="fas fa-times"></i> Invalid</button>
                                <button class="btn btn-flat btn-lg btn-outline-danger cancel_data" type="button" data-id="<?php echo $id ?>" data-val="2" data-sign="3" data-name="<?php echo $_settings->userdata('EMPLOYID') ?>"> <i class="fas fa-trash"></i> Cancel</button>
                    ...
                    <?php } else if ($hr_status == 0 && ($is_quality > 0)) { ?>
                ...
                <div class="row justify-content-between">
                    ...
                    ?>
                        ...
                        <?php // } else if ($dh_status == 0 && $hr_status == 1 && $sv_status == 1 && $_settings->userdata('EMPPOSITION') > 2) { 
                        ?>
                        <!-- <input type="hidden" readonly name="dh_sign_date" id="dh_sign_date" value="<?php echo date('Y-m-d H:i:s') ?>" required>
                        <div class="col-5">
                            <label class="control-label text-info ">For approval :</label>
                            <div class="button-wrapp text-center">
                                <button class="btn btn-flat btn-lg btn-outline-success approve_data" type="button" data-id="<?php echo $id ?>" data-val="1" data-sign="2" data-name="<?php echo $_settings->userdata('EMPLOYID') ?>"> <i class="fas fa-thumbs-up"></i> Approved</button>
...
<script>
    $(document).ready(function() {
        ...
        $('.disapprove_data').click(function() {
            ...
            // appr_irda($(this).attr('data-id'), $(this).attr('data-val'), $(this).attr('data-sign'), $(this).attr('data-name'));
            uni_modal("", "incidentreport/approveIR/disappr.php?id=" + $(this).attr('data-id'), 'mid-large');
        })
