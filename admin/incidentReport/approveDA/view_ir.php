        ...
        <form action="" id="ir-form">
            ...
            <div class="container-fluid">
                ...
                if ($ir_status == 2) {
                    ...
                    // $appr_by_dh = $conn->query("SELECT EMPNAME FROM employee_masterlist WHERE EMPLOYID = (SELECT APPROVER2 from employee_masterlist WHERE employid= '{$emp_no}')")->fetch_array();
