        ...
        <form action="" id="ir-form">
            ...
            <div class="container-fluid">
                <div class="printable">
                    ...
                    <?php
                    if (($_settings->userdata('EMPLOYID') == $approver_1) || ($_settings->userdata('EMPPOSITION')  > 2)) { ?>
                        <hr>
                        <br>
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                ...
                                <textarea required <?php echo $_settings->userdata('EMPLOYID') == $approver_1 ? 'required' : 'readonly' ?> type="text" name="assessment" placeholder="Input details of admin hearing/counseling" class="form-control  rounded-0"><?php echo isset($assessment)  ? $assessment : '' ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label class="control-label text-info">Recommendation</label>
                                <textarea required <?php echo $_settings->userdata('EMPLOYID') == $approver_1 ? 'required' : 'readonly' ?> type="text" name="recommendation" class="form-control  rounded-0"><?php echo isset($recommendation)  ? $recommendation : '' ?></textarea>
                            </div>
                ...
                <div class=" py-1 text-center">
                    ...
                    <?php if ($ir_status != 3 && $dh_status == 0 && $hr_status == 1 && $sv_status == 1 && $_settings->userdata('EMPPOSITION') > 2) { ?>
                        <br>
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12">
                                ...
                                <div class="button-wrapp text-center">
                                    ...
                                    <!-- <button class="btn btn-flat btn-lg btn-outline-danger disapprove_data" type="button" data-id="<?php echo $id ?>" data-val="2" data-sign="2" data-name="<?php echo $_settings->userdata('EMPLOYID') ?>"> <i class="fas fa-thumbs-down"></i> Disapproved</button> -->
...
<script>
    $(document).ready(function() {
        ...
        $('.disapprove_data').click(function() {
            ...
            // appr_irda($(this).attr('data-id'), $(this).attr('data-val'), $(this).attr('data-sign'), $(this).attr('data-name'));
            uni_modal("", "incidentreport/approveIR/mngr_disappr.php?id=" + $(this).attr('data-id'), 'mid-large');
        })
        // $('.edt').click(function() {
