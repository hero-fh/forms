        ...
        <form action="" id="ir-form">
            ...
            <div class="container-fluid">
                <div class="printable">
                    ...
                    <?php
                    if (($_settings->userdata('EMPLOYID') == $sv_name) || ($_settings->userdata('EMPPOSITION')  >= 2)) { ?>
                        <hr>
                        <br>
                        ...
                        <?php endif; ?> -->
                                            ...
                                            <td class="text-center">
                                                <div class="icheck-primary btn-lg d-inline">
                                                    <input type="checkbox" <?php echo isset($row['valid']) && $row['valid'] == 0 ? 'required' : '' ?> class="con_yes" data-id="<?php echo $row['id'] ?>" data-val="<?php echo $row['da_type'] ?>" id="con_yes<?php echo $row['id'] ?>" value="1" <?php echo isset($row['valid']) && $row['valid'] == 1 ? 'checked' : '' ?> name="valid[]">
                                            ...
                                            <td class="text-center">
                                                <div class="icheck-primary btn-lg d-inline">
                                                    <input type="checkbox" <?php echo isset($row['valid']) && $row['valid'] == 0 ? 'required' : '' ?> class="con_no" data-id="<?php echo $row['id'] ?>" data-val="<?php echo $row['da_type'] ?>" id="con_no<?php echo $row['id'] ?>" value="2" <?php echo isset($row['valid']) && $row['valid'] == 2 ? 'checked' : '' ?> name="valid[]">
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <a class="btn btn-sm btn-block edt" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><i class="fas fa-eye text-dark"> View letter of explanation</i></a>
                                            </td>
                                        </tr>
                                        <tr class="sus_date<?php echo $row['id'] ?>  <?php echo ($row['da_type'] == 3 || $row['da_type'] == 4 || $row['da_type'] == 6) && $row['valid'] == 1 ? '' : 'd-none' ?>">
                                            <td class="text-center" colspan="2">
                                                <label class="control-label">No of days:</label>
                                                <input readonly type="number" id="days_no<?php echo $row['id'] ?>" name="days_no[]" required class="form-control text-center" value="<?php echo $row['da_type'] == 3 ? 3 : 7 ?>">
                                                <!-- <?php if ($shift == 'N') { ?>
                                                    <input readonly type="number" id="days_no<?php echo $row['id'] ?>" name="days_no[]" required class="form-control text-center" value="<?php echo $row['da_type'] == 3 ? 3 : 7 ?>">
                                                <?php } else { ?>
                                                    <input readonly type="number" id="days_no<?php echo $row['id'] ?>" name="days_no[]" required class="form-control text-center" value="<?php echo $row['da_type'] == 3 ? 2 : 5 ?>">
                                                <?php } ?> -->
                                            </td>
                                            <td class="text-center" colspan="5">
                                                <label class="control-label">Suspension date: </label>
                                                <input type="text" id="date_of_suspension<?php echo $row['id'] ?>" autocomplete="off" name="date_of_suspension[]" class="form-control datepicker text-center" <?php echo $row['da_type'] == 3 || $row['da_type'] == 4 ? '' : 'readonly' ?> value="<?php echo $row['date_of_suspension'] ?>">
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                ...
                                <textarea required <?php echo isset($sv_name) && $_settings->userdata('EMPLOYID')  == $sv_name ? 'required' : 'readonly' ?> type="text" name="assessment" placeholder="Input details of admin hearing/counseling" class="form-control  rounded-0"><?php echo isset($assessment)  ? $assessment : '' ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label class="control-label text-info">Recommendation</label>
                                <textarea required <?php echo isset($sv_name) && $_settings->userdata('EMPLOYID')  == $sv_name ? 'required' : 'readonly' ?> type="text" name="recommendation" class="form-control  rounded-0"><?php echo isset($recommendation)  ? $recommendation : '' ?></textarea>
                            </div>
                        </div>
                ...
                <?php if ($dh_status == 0) {
                    $appr_by = $conn->query("SELECT EMPNAME FROM employee_masterlist WHERE EMPLOYID = '{$sv_name}'")->fetch_array()[0];
                    $valid_by = $conn->query("SELECT EMPNAME FROM employee_masterlist WHERE EMPLOYID = $valid_to_da_name")->fetch_array()[0];
                ?>
                    <div class="row justify-content-between">
                        ...
                        <div class="col-5">
                            <label class="control-label text-info">Assessed by :</label>
                ...
                <div class=" py-1 text-center">
                    ...
                    <?php if ($dh_status == 0 && $hr_status == 1 && $sv_status == 1 && $_settings->userdata('EMPPOSITION') >= 2) { ?>
                        <div class="row justify-content-between">
                            ...
                            <div class="col-12">
                                <?php if ($appeal_status == 0) { ?>
                                    ...
                                    <div class="button-wrapp text-center">
                                        <button class="btn btn-flat btn-lg btn-outline-success approve_data" type="button" data-id="<?php echo $id ?>" data-val="1" data-sign="2" data-name="<?php echo $_settings->userdata('EMPLOYID') ?>"> <i class="fas fa-thumbs-up"></i> Acknowledge</button>
                                        <?php
                                        $appeal_rows = $conn->query("SELECT * FROM `ir_list` where `ir_no` = '$ir_no' and (da_type = 3 or da_type = 4)")->num_rows;
                                        if ($appeal_rows > 0) { ?>
                                            <!-- <button class="btn btn-flat btn-lg btn-outline-warning appeal_data" type="button" data-id="<?php echo $id ?>" data-val="2" data-sign="2" data-name="<?php echo $_settings->userdata('EMPLOYID') ?>"> <i class="fas fa-gavel"></i> Appeal</button>
                                            <button class="btn btn-flat btn-lg btn-outline-danger d-none close_appeal_data" type="button" data-id="<?php echo $id ?>" data-val="2" data-sign="2" data-name="<?php echo $_settings->userdata('EMPLOYID') ?>"> <i class="fas fa-times"></i> Close</button> -->
                                        <?php } ?>
                                    </div>
                                    <i class="text-info" style="display:block; text-align: center;">Approver 2</i>
                                <?php } else { ?>
                        ...
                        <?php } ?>
                        <a class="btn btn-flat btn-dark" href="<?php echo base_url . 'admin?page=incidentreport/approveIR' ?>">Back</a>
                        </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        //     // appr_irda($(this).attr('data-id'), $(this).attr('data-val'), $(this).attr('data-sign'), $(this).attr('data-name'));
        //     uni_modal("", "incidentreport/approveIR/appeal_letter.php?id=" + $(this).attr('data-id'), 'large');
        // })
        console.log(click)
    ...
    $(document).ready(function() {
        ...
        $('.con_yes').change(function() {
            if ($('#con_yes' + $(this).attr('data-id')).is(':checked')) {
                ...
                if ($(this).attr('data-val') == 3 || $(this).attr('data-val') == 4)
                    $('.sus_date' + $(this).data('id')).removeClass('d-none');
        ...
        $('.con_no').change(function() {
            if ($('#con_no' + $(this).attr('data-id')).is(':checked')) {
                ...
                if ($(this).attr('data-val') == 3 || $(this).attr('data-val') == 4)
                    $('.sus_date' + $(this).data('id')).addClass('d-none');
