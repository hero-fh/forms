            ...
            <div class="container-fluid">
                <div class="printable">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <?php } elseif ($da_status == 2 && $_settings->userdata('EMPLOYID') == $sv_name && $sv_name != $dh_name) { ?>
                            <div class="col-5">
                                <label class="control-label  text-info">For acknowledgement : </label>
                    ...
                    <div class="row justify-content-between">
                        <?php if ($da_status >= 4) {
                            $mngr = $conn->query("SELECT EMPNAME FROM employee_masterlist WHERE EMPLOYID = $dh_name")->fetch_array()[0]; ?>
                            <div class="col-5">
                        ...
                        <?php } elseif (($da_status == 3 && $_settings->userdata('EMPLOYID') == $dh_name) || ($da_status == 2 && $_settings->userdata('EMPLOYID') == $sv_name && $sv_name == $dh_name)) { ?>
                            <div class="col-5">
                                <label class="control-label  text-info">For acknowledgement : </label>
                                <a href="javascript:void(0)" class="btn btn-block btn-success ack_data" data-id="<?php echo $id ?>" data-sign="4" data-emp="<?php echo $emp_no ?>">Acknowledge</a>
                                <i class="text-info" style="display:block; text-align: center;">Approver 2</i>
                            </div>
                            <div class="col-4">
                                <label class="control-label  text-info">Date </label>
