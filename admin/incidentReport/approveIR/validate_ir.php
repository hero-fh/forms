        ...
        <form action="" id="ir-form">
            ...
            <div class="container-fluid">
                <div class="printable">
                    ...
                    <?php
                    if ($_settings->userdata('DEPARTMENT') == 'Human Resource' ||  $is_quality > 0 ||  $is_operator > 0 ||  $_settings->userdata('EMPLOYID') == 1191) { ?>
                        <hr>
                        <br>
                ...
                <div class=" py-1 text-center">
                    ...
                    <?php if ($da_status == 0 && $quality_violation == 1 && $is_operator > 0) { ?>
                        <?php if ($hr_status == 1 && $sv_status != 0) {
                            $appr_by = $conn->query("SELECT EMPNAME FROM employee_masterlist WHERE EMPLOYID = '{$sv_name}'")->fetch_array()[0];
                        ?>
                            <div class="row justify-content-between">
                                <div class="col-5">
                                    <label class="control-label text-info"><?php echo isset($sv_status) && $sv_status == 2 ? 'Disapproved' : 'Assessed' ?> by :</label>
                                    <input readonly type="text" class="form-control" id="sv_name" value="<?php echo isset($appr_by)  ? $appr_by : '' ?>">
                                    <i class="text-info" style="display:block; text-align: center;">Approver 1</i>
                                </div>
                                <div class="col-4">
