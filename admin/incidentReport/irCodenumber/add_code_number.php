...
<div class="container-fluid">
	<form action="" id="code_number-form">
		...
		<div class="form-group">
			...
			<!-- <input name="violation" id="violation" type="text" class="form-control form-control-sm form-control-border" value="<?php echo isset($violation) ? $violation : ''; ?>"> -->
			<textarea name="violation" id="violation" class="form-control form-control-sm form-control-border"><?php echo isset($violation) ? $violation : ''; ?></textarea>
		</div>
		<div class="form-group">
