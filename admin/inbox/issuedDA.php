<div class="card card-outline card-primary">
    <div class="card-header p-0 pt-1 ">
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
            <li class="pt-2 px-3">
                <h3 class="card-title">List of diciplinary action</h3>
            </li>
            <li class="nav-item">
                ...
                <div class="container-fluid">
                    <table class="table table-bordered table-stripped">
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            $qry = $conn->query("SELECT * FROM ir_requests where ir_status = 2 and has_da = 1 and acknowledge_da = 0 and da_status = 4 and emp_no =  '{$_settings->userdata('EMPLOYID')}' ORDER BY `date_created` desc");
                            while ($row = $qry->fetch_assoc()) :
                                if ($row['ir_status'] == 2 && $row['why1'] != '') {
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php elseif ($row['ir_status'] == 2 && $row['has_da'] == 1) : ?>
                                                <span class="badge badge-success rounded-pill">For acknowledgement</span>
                                            <?php else : ?>
                                        ...
                                        <td align="center">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="<?php echo base_url . 'admin?page=inbox/viewDA&id=' . md5($row['id']) ?>" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
                ...
                <div class="container-fluid">
                    <table class="table table-bordered table-stripped">
                        ...
                        <tbody>
                            <?php
                            $i = 1;
                            $qry = $conn->query("SELECT * FROM ir_requests where ir_status = 2 and has_da = 1 and acknowledge_da = 1 and emp_no = " . $_settings->userdata('EMPLOYID') . " ORDER BY `date_created` desc");
                            while ($row = $qry->fetch_assoc()) :
