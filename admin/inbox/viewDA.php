        ...
        <form action="" id="ir-form">
            ...
            <div class="container-fluid">
                <div class="printable">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-4">
                            ...
                            <input readonly required type="date" name="da_requested_date" class="form-control  rounded-0" class="form-control  rounded-0" value="<?php echo date('m/d/Y h:i a', strtotime($valid_to_da_date)) ?>">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <?php } elseif ($da_status == 3 && $_settings->userdata('EMPLOYID') == $dh_name) { ?>
                            <div class="col-5">
                                <label class="control-label  text-info">For acknowledgement : </label>
                ...
                <div class=" py-1 text-center">
                    ...
                    <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=inbox/issuedDA' ?>">Back</a>
